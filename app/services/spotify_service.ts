...
export class SpotifyService {
  ...
  async getPlaylistInfo(spotifyPlaylistId: string): Promise<SpotifyPlaylistObject> {
    return this.fetchSpotify<SpotifyPlaylistObject>(`/playlists/${spotifyPlaylistId}?fields=id,name,description,images,tracks`)
  }
  ...
  async getSpotifyProfile(accessToken: string): Promise<{ id: string; display_name: string; images: { url: string }[] }> {
