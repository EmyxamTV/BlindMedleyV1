...
export class LeaderboardService {
  ...
  async getLeaderboard(
    ...
    const periodKey = period === 'weekly' ? this.getWeeklyPeriod() : period === 'monthly' ? this.getMonthlyPeriod() : 'global'
  ...
  async getUserRank(userId: number, period: 'global' | 'weekly' | 'monthly'): Promise<number | null> {
    const periodKey = period === 'weekly' ? this.getWeeklyPeriod() : period === 'monthly' ? this.getMonthlyPeriod() : 'global'
