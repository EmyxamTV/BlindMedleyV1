...
router
  .group(() => {
    ...
    router.post('/admin/playlists/import', [AdminController, 'importPlaylist']).as('admin.playlists.import')
    router.post('/admin/playlists/:id/toggle', [AdminController, 'togglePlaylist']).as('admin.playlists.toggle')
  })
